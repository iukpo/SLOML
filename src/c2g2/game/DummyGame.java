...
public class DummyGame implements IGameLogic {
    ...
    //These two are for video
    private static final float ROTATION_STEP_VIDEO = 0.15f;
    
    private static boolean beginDemo = false;
    ...
    public DummyGame() {
        ...
        //NB: Change this to test getViewMatrix
    ...
    public void init(Window window) throws Exception {
        ...
        /*This mesh below is available from TF3DM.com. Not included for licensing reasons, but do download and
        try it out!*/
        //Mesh mesh = OBJLoader.loadMesh("/resources/models/death-star-II.obj");
        
        Mesh mesh = OBJLoader.loadMesh("/resources/models/bunny.obj");
        
        //Mesh mesh = new Mesh();  // comment this line when you enable OBJLoader
        
        //Change material to change "color" of object.
        Material material = new Material(new Vector3f(0.2f, 0.5f, 0.5f), reflectance);
        
        //Makes the object appear silvery if it does not have a material loaded.
        //Material material = new Material(new Vector3f(0.75f, 0.75f, 0.75f), reflectance);
        ...
        /*
         * These two lines were added by me to ensure that model loaded in window.
         * Without them, it seems that the initial position of the mesh-as-object
         * does not appear where it should (undefined position?) and the model
         * may appear too big for the window.
         * 
         * Development done on Windows 10 machine. YMMV.
         * 
         */
        
        /*One may need to adjust the two lines below to get the model to appear both completely and in the center
         * of the window. TODO: Extend the program to take command line arguments rather than hardcoding in the 
         * numbers.
         */
        
        //For Stanford Rabbit (bunny.obj)
         gameItem.setScale(0.25f);
	     gameItem.setPosition(-0.60f, -0.85f, -2.0f);
        
        //For death-star-ii.obj
        /*gameItem.setScale(0.000625f);
        gameItem.setPosition(-0.8f, -0.5f, -2.0f);*/
    ...
    public void input(Window window, MouseInput mouseInput) {
    	...
    	if(window.isKeyPressed(GLFW_KEY_Q)){
    		...
    		//gameItems[currentObj].getMesh().translateMesh(new Vector3f(0.05f,0.00f,0f));
    	}
    ...
    public void update(float interval, MouseInput mouseInput) {
    	...
    	//For turning moon automatically for video...
    	if (beginDemo)
    	{
    		Vector3f rotVideo = gameItems[currentObj].getRotation();
    		gameItems[currentObj].setRotation(rotVideo.x, rotVideo.y+ROTATION_STEP, rotVideo.z);
    	}
